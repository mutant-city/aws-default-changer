...
regions = list_all_in_dir(root_dir + '/config-files')
i = 0
...
os.system("ln -fs " + root_dir +  "/config-files/" + regions[int(region)] + " " + root_dir +  "/config")
os.system("ln -fs " + root_dir +  "/cred-files/" + creds[int(cred)] + " " + root_dir +  "/credentials")